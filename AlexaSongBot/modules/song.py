...
async def song(client, message):
    ...
    if args.startswith(" "):
        ...
        return ""
    status = await message.reply("[Nirvana](https://telegra.ph/file/7cf7cf3ccca5d6a4f0625.jpg) is started searching on YouTube my [developer](https://t.me/POWER_OF_TELEGRAMX)")
